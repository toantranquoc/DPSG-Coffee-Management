 ...
 * @author pc
 */
public class DLThemLoaiMon extends javax.swing.JDialog {

    /**
     * Creates new form DLThemLoaiMon
     */
    public ConnectDB cn = new ConnectDB();

    public DLThemLoaiMon(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lbNameSuaLoai.setText("THÊM LOẠI MÓN MỚI");
    ...
    private void btnOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOKActionPerformed
        ...
        {   
            if(cn.isExistLoai(txtTenNhomMoi.getText())){
                JOptionPane.showMessageDialog(null, "Tên nhóm món đã tồn tại!");
            }
            ...
            if ("#ffffff".equals(hex)) {
                JOptionPane.showMessageDialog(null, "Chọn màu sắc để hiển thị!");
                return;
            }
            Loai newLoai = new Loai();
            newLoai.SetTenLoai(txtTenNhomMoi.getText().toString());
            newLoai.SetMauSac(hex);
            if (cn.InsertLoai(newLoai) > 0) {
                JpQuanLyLoaiMon.loaiMon.fillTableLoaiMon();
                JpQuanLyLoaiMon.loaiMon.updateUI();
                JOptionPane.showMessageDialog(null, "Thêm nhóm món mới thành công!");
            } else {
                JOptionPane.showMessageDialog(null, "Thêm nhóm món mới thất bại!");
            }
            dispose();
        }
        }
